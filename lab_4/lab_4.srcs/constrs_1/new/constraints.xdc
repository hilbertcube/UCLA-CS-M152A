...
## clk_div toggles pix_clk every 2 input cycles, so the output clock is 25 MHz.
create_generated_clock -name pix_clk -source [get_ports clk] -divide_by 4 [get_pins u_clk_div/pix_clk_reg/Q]


## Switches (unused for this project)
...
##Buttons
## Basys3 has 5 buttons in a cross layout:
##   U18 = center (we use as hard reset)
##   T18 = up     (we use as fire)
##   W19 = left   (move player left)
##   T17 = right  (move player right)
##   U17 = down   (hold 3s to soft-reset / "BTNB" in proposal)
